  ...
  const handleUpload = async (file) => {
    try {
      const userResponse = await axios.get(
        `http://localhost:3000/User/getbyemail?email=${USER.email}`
      );
      ...
      const response = await axios.put(
        `http://localhost:3000/User/avatar/${userId}`,
        formData,
        {
          headers: {
  ...
  useEffect(() => {
    const fetchGroupeReservation = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3000/reservation/getBygroupe/"
        );
    ...
    const fetchBuffets = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:3000/buffet/getbyuserId/${userId}`
        );
        const buffetData = response.data;
    ...
    const fetchReservations = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:3000/Reservation/getreservation/${userId}`
        );
    ...
    const fetchFeedbacks = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:3000/feedback/getFeedbackByUser/${userId}`
        );
              ...
              <div className="profile-info">
                  ...
                  <div className="mx-2">
                    <InputGroup>
                      ...
                      <InputGroup.Text
                        ...
                        onClick={() =>
                          document.getElementById(`fileInput-${userID}`).click()
                        }
                      >
                ...
                <div className="profile-details">
                  ...
                  {USER.email === loggedInUser.email ? (
                    <>
                      <button
                        style={{ marginLeft: "62%", marginBottom: "30px" }}
                        className="btn btn-primary  "
                        onClick={goTomChat}
                      >
                        {" "}
                          ...
                          <div className="profile-news">
                            <div className="media pt-3 pb-3">
                              ...
                              <div className="media-body">
                                ...
                                <p
                                  style={{ paddingLeft: "250px", color: "red" }}
                                >
                                  {item.date}
                                </p>
                              </div>
                    ...
                    <div className="card">
                      ...
                      <div className="card-body pt-3">
                        <div className="profile-blog ">
                          ...
                          <p className="mb-0">{reservation.description}</p>
                        </div>
                      </div>
                    </div>
                  </div>
