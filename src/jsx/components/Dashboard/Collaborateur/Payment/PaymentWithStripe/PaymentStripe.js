...
const PaymentStripe = () => {
   ...
   const [selectedBuffetId, setSelectedBuffetId] = useState(""); // État pour l'ID du buffet sélectionné
                            ...
                            <Form className="needs-validation" noValidate="" onSubmit={handleSumbitPayment}>
                               ...
                               <div className="mb-3">
                                  ...
                                  <select
                                      ...
                                      onChange={(e) => setSelectedBuffetId(e.target.value)} // Mettre à jour l'état
                                  >
