...
import SuccessPaymentFlouci from "./jsx/components/Dashboard/Collaborateur/Payment/PaymentWithFlouci/SuccessPaymentFlouci";
import CancelPaymentFlouci from "./jsx/components/Dashboard/Collaborateur/Payment/PaymentWithFlouci/CancelPaymentFlouci";

const SignUp = lazy(() => import("./jsx/pages/Registration"));
const Login = lazy(() => import("./jsx/pages/Login"));
const SuccessPayment = lazy(() =>
  import(
    "./jsx/components/Dashboard/Collaborateur/Payment/PaymentWithStripe/SuccessPayment"
  )
);
...
function App(props) {
  ...
  const allroutes = [
    ...
    {
      url: "/catalogue/:codeBranche/products",
      component: <CatalogueProductsPage />,
    },
